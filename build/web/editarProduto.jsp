<%-- 
    ...
    Created on : 11/11/2011, 09:44:30
    Author     : RAFAELA
--%>
        ...
        <div id='container'> 
            ...
            <div id='mainContent'> 
                ...
                <html:form action="/ProdutoAction" >    
                   <h2>ALTERAR DE PRODUTO</h2><br/>
                    
                    <bean:write name="editarProdutoForm" property="mensagem" />
                    <TABLE border='0' cellpadding='2' cellspacing='0' width='60%' class='tabela2'>

                        <tr>
                            <td >Descrição: </td><td ><html:text property="descricao" maxlength="50" size="50" value="" />
                        </tr>
                    ...
                    <td  align='right'><html:submit property="funcao" value="editar" /></td>
                    <td ></td></tr>
                    </table>
                </html:form>
